# Operator Quickstart — Community Cargo Handling Operations

Shortest path from clone to a verified local dry-run for **ISIC 5224** (`cloud-itonami-isic-5224`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5224.git
cd cloud-itonami-isic-5224
```
...
- Blueprint governor key: `cargo-handling-governor`
- Likely source path: `src/**/cargo-handling-governor.cljc`
